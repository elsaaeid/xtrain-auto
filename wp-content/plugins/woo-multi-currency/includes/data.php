...
class WOOMULTI_CURRENCY_F_Data {
	...
	public function __construct() {
		...
		if ( ! $wmc_settings ) {
			...
			// Determine core currency: use WooCommerce setting, otherwise default to SAR
			$core_currency = get_option( 'woocommerce_currency' );
			if ( empty( $core_currency ) ) {
				$core_currency = 'SAR';
			}
			$wmc_settings['currency_core']     = $core_currency;
