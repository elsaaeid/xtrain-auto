...
// Language switcher for WordPress dashboard (matches uploaded image style)
function show_language_switcher($current_lang = 'en') {
    echo '<div style="background:#ec7a37; color:#fff; padding:8px 0; text-align:right; font-family:inherit; font-size:16px;">';
    echo '<span style="margin-right:32px;">';
    echo '<a href="?lang=en" style="color:#fff; text-decoration:none;">English</a>';
    echo '<span style="margin:0 12px;">&#9660;</span>';
    echo '<a href="?lang=ar" style="color:#fff; text-decoration:none;">عربى</a>';
    echo '<span style="margin:0 12px;">&#9660;</span>';
    echo '</span>';
    echo '</div>';
}
